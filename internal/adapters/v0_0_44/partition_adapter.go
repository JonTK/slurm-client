...
// PartitionAdapter implements the PartitionAdapter interface for v0.0.44
...
// NewPartitionAdapter creates a new Partition adapter for v0.0.44
func NewPartitionAdapter(client *api.ClientWithResponses) *PartitionAdapter {
	return &PartitionAdapter{
		BaseManager: base.NewBaseManager("v0.0.44", "Partition"),
		client:      client,
...
func (a *PartitionAdapter) List(ctx context.Context, opts *types.PartitionListOptions) (*types.PartitionList, error) {
	...
	if opts != nil {
		// Note: v0.0.44 doesn't have a PartitionName parameter for filtering
...
func (a *PartitionAdapter) Create(ctx context.Context, partition *types.PartitionCreate) (*types.PartitionCreateResponse, error) {
	// v0.0.44 doesn't support partition creation through the REST API
	return nil, errors.NewClientError(
		errors.ErrorCodeUnsupportedOperation,
		"partition creation not supported in v0.0.44",
...
func (a *PartitionAdapter) Update(ctx context.Context, partitionName string, update *types.PartitionUpdate) error {
	// v0.0.44 doesn't support partition updates through the REST API
	return errors.NewClientError(
		errors.ErrorCodeUnsupportedOperation,
		"partition updates not supported in v0.0.44",
		"Method not allowed (405)")
}

// Delete deletes a partition
func (a *PartitionAdapter) Delete(ctx context.Context, partitionName string) error {
	// v0.0.44 doesn't support partition deletion through the REST API
	return errors.NewClientError(
		errors.ErrorCodeUnsupportedOperation,
		"partition deletion not supported in v0.0.44",
		"Method not allowed (405)")
}
...
// convertAPIPartitionToCommon converts a v0.0.44 API Partition to common Partition type
// extractPartitionState extracts the partition state from API structure
func (a *PartitionAdapter) extractPartitionState(apiPartition api.V0044PartitionInfo) types.PartitionState {
...
func (a *PartitionAdapter) extractPartitionNodes(apiPartition api.V0044PartitionInfo) (string, int32) {
	var nodes string
...
func (a *PartitionAdapter) extractPartitionLimits(apiPartition api.V0044PartitionInfo) (int32, int32, int32, int32) {
...
func (a *PartitionAdapter) extractPartitionPriority(apiPartition api.V0044PartitionInfo) int32 {
...
func (a *PartitionAdapter) extractPartitionAccounts(apiPartition api.V0044PartitionInfo) ([]string, []string) {
...
func (a *PartitionAdapter) extractPartitionQoS(apiPartition api.V0044PartitionInfo) ([]string, []string, string) {
...
func (a *PartitionAdapter) convertAPIPartitionToCommon(apiPartition api.V0044PartitionInfo) *types.Partition {
	...
	// Flags - v0.0.44 doesn't have a direct Flags field
